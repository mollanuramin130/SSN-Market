...
?>
<!--
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_cart; ?>) ; height:20vh">
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <h1 class="fa-sharp fa-solid fa-person-dolly-empty"><i></i><?php echo 'Cart is empty'; ?></h1>
                <?php else: ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" class="input-text qty text" step="1" min="1" max="" name="quantity[]" value="<?php echo $arr_cart_p_qty[$i]; ?>" title="Qty" size="4" pattern="[0-9]*" style="width:55px;" inputmode="numeric">
                                <p style="margin-top: 5px;">
                                <input type="submit" value="UPDATE" class="btn btn-primary btn-xs" name="form1"></p>
                            </td>
                            <td class="text-right">
                                <?php
                ...
                <div class="cart-buttons">
                    <tr><a href="checkout.php"><span class="btn btn-success btn-lg" style="width: 100%; height: 50px;"><?php echo "Order Now."; ?></span></a></tr>
                </div>
                </form>
                <?php endif; ?>
