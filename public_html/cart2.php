		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="cart-buttons">
                        ...
                        <tr></tr><input type="submit" value="<?php echo LANG_VALUE_20; ?>" class="btn btn-warning" name="form1"></tr>
                        <tr><a href="index.php" class="btn btn-info"><?php echo LANG_VALUE_85; ?></a></tr>
                    
                    <br><br>
                    
                    <tr><a href="checkout.php"><span class="btn btn-danger btn-lg"><?php echo "Order Now."; ?></span></a></tr>
