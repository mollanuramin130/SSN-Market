                        ...
                        <td>
                            <?php
                                ...
                                foreach ($result50 as $row50) {
                                    echo '<b>Customer Phone:</b><br>'.$row50['cust_phone'];
                                    echo '<br><b>Delivery Name:</b><br>'.$row50['cust_s_name'];
                                    echo '<br><b>Delivery Phone:</b> '.$row50['cust_s_phone'];
                                    echo '<br><b>Address:</b><br>'.$row50['cust_s_country'].','.$row50['cust_s_address'].','.$row50['cust_s_city'].','.$row50['cust_s_state'].','.$row50['cust_s_zip'];                                
                               }
            		        ?>
                        </td>
                        <td>
