...
?>
<!--
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_product_category; ?>); height: 20vh;">
    <div class="inner">
                                    ...
                                    <div class="col-md-4 item item-product-cat">
                                        <div class="inner">
                                            <div class="thumb">
                                                ...
                                                <div class="photo img-rounded" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>); "></div>
                                                </a>
                                            </div>
                                            <div class="text">
