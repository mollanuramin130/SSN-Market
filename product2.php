...
<script>
    $(document).ready(function() {
        // Capture the change event for the quantity input field
        $('#product-quantity').on('input', function() {
            var quantity = $(this).val(); // Get the quantity value

            $.ajax({
                url: 'update_quantity.php', // The server-side script that will process the request
                type: 'POST',
                data: { qty: quantity },
                ...
                error: function(xhr, status, error) {
                    ...
                    console.error('AJAX Error: ' + status + error);
							...
							<div class="btn-cart btn-cart1">
                                ...
                                <button name="form_add_to_cart" class="btn btn-warning" style="width: 25%; height: 40px;">Add to Card</button>
                                <br><br>
                                

                                <button name="form_add_to_cart" class="highlight-button">Order Now</button>
...
<style>
  ...
  .highlight-button:hover {
    ...
    transform: scale(1.05);    /* Slightly increase size on hover */
                                ...
                                <!--<button class="btn btn-warning btn-lg"><a href="cart.php?id=<?php echo $row['p_id']; ?>">Order Now</a></button>-->
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            <div class="thumb">
                                ...
                                <div class="photo img-responsive img-fluid" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>);"></div>
                                <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text">
                                ...
                                <?php else: ?>
                                    ...
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i>  Add to Cart</a></p>
                                    <a href="cart.php?id=<?php echo $row['p_id']; ?>"><button class="btn btn-success">Order Now <span class="badge"><?php
                                        $i = 0;
                            ...
                            ?>
             <?php echo count($arr_cart_p_id)-1; ?>
                                        <?php 
                                    ?></span></button></a>
                                </div>
                                <?php endif; ?>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i>  Add to Cart</a></p>
                                    <p><a href="cart.php?id=<?php echo $row['p_id']; ?>">Order Now</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
