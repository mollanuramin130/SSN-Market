                ...
                <div class="user-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            -->
                            <div class="col-md-6 form-group">
                                <label for=""><?php echo "Email Address (Optional)"; ?></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label for=""><?php echo "City (Optional)"; ?> </label>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="cust_state" value="<?php echo isset($_SESSION['customer']['cust_state']) && !empty($_SESSION['customer']['cust_state']) ? $_SESSION['customer']['cust_state'] : 'West Bengal'; ?>">
