...
<div>
    <h4 style="margin-left:15px;">Shop Menu..</h4>
...
<!--
<div>
    <h3 style="margin-left:15px; text-align:center;"><i class="fa fa-arrow-left"></i> Sweet Corner Menu <i class="fa fa-arrow-right"></i></h3>
    <div id="slider-5-offers-slider">
        <div class="d-flex offer-slider overflow-auto" id="slider-5-categories-slider"></div>
    </div>
</div>
-->
<!-- Include shared scrolling functionality -->
<script src="./shared-functions.js"></script>

<!-- Include specific content scripts -->
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item col-md-3" >
                            <div class="thumb">
                                ...
                                <div class="photo img-responsive img-fluid img-rounded" style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>);"></div>
                                <!--
                            ...
                            <div class="text ">
                                ...
                                <div class="item-box text-center">
                                    <ul><a href="product.php?id=<?php echo $row['p_id']; ?>" class="btn btn-success">Order Now</a></ul>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
